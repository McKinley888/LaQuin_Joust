...
public class Screen extends Canvas implements Runnable
{
    ...
    public void drawBackground(Graphics g)
    {
        ...
        g.drawImage(Images.background,-420,0, null);
    }
    ...
    public void init()
    {
        ...
        land1 = new Land(0,Reference.CENTER_Y - 40, Reference.WIDTH / 4, 40, Reference.gold);
        land2 = new Land(Reference.CENTER_X - 80,90,80,40, Reference.gold);
        land3 = new Land(Reference.CENTER_X, Reference.CENTER_Y, Reference.WIDTH /2, 40, Reference.gold);

        player = new Bird(0,0, 40,40,Reference.chocolate);
        cpu1 = new Bird(Reference.CENTER_X - 50,0,40,40,Reference.strawberry);
